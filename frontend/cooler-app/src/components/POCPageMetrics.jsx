...
export class POCPageMetrics extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <React.Fragment>
                ...
                <div
                    style={{
                        ...
                        height: 104,
                        backgroundColor: '#2A2E53',
                        boxShadow: '0px 0px 20px rgba(255, 153, 80, 0.1)',
                        borderRadius: '15px'
                    }}
                >
                    <img
                ...
                <div
                    style={{
                        ...
                        height: 104,
                        backgroundColor: '#2A2E53',
                        boxShadow: '0px 2px 10px rgba(0, 178, 255, 0.1)',
                        borderRadius: '15px'
                    }}
                >
                    <img
