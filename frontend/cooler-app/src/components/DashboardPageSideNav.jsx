...
export class DashboardPageSideNav extends Component {
    constructor(props) {
        super(props);
        this.state = {};
            ...
            <React.Fragment>
                ...
                >
                    <img
                        ...
                        src="icons/Nav Icons/Dashboard-Icon_Selected.svg"
                        style={{
                            position: 'absolute',
                            left: 10,
                            top: 25,
                        ...
                        onMouseLeave={(e) => {
                            if (this.dashboardPageButtonRef.current) {
                                this.dashboardPageButtonRef.current.src = "icons/Nav Icons/Dashboard-Icon_Selected.svg"
                            }
                        }}
                        onMouseDown={(e) => {
                            if (this.dashboardPageButtonRef.current) {
                    ...
                    <img
                        ...
                        alt=""
                        title="Click to navigate to Cooler Page"
                        src="Icons/Nav Icons/Cooler-Icon_Rest.svg"
                        style={{
                            position: 'absolute',
                            left: 10,
                            top: 76,
                        ...
                        onMouseLeave={(e) => {
                            if (this.coolerPageButtonRef.current) {
                                this.coolerPageButtonRef.current.src = "icons/Nav Icons/Cooler-Icon_Rest.svg"
                            }
                        }}
                        onMouseDown={(e) => {
                            if (this.coolerPageButtonRef.current) {
...
export default DashboardPageSideNav;